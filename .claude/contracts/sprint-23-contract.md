# Sprint 23 Contract — Smoother Agent Journey

**Status**: LOCKED
**Reviewed**: 2026-05-09

## Review Notes
- 23 ACs align 1:1 with evaluation criteria
- lib-helpers.sh already sourced by 3/4 gate scripts; pre-flight-gate.sh needs source line added
- compute_pending_gates() checks file existence only — fast, no jq parsing needed for most checks
- 36 block messages across 3 scripts — mechanical edits, low risk per edit
